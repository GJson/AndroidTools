...
import com.gjson.androidtools.library.imagepicker.DataHolder;
import com.gjson.androidtools.library.imagepicker.ImageDataSource;
import com.gjson.androidtools.library.imagepicker.ImagePicker;
import com.gjson.androidtools.library.imagepicker.adapter.ImageFolderAdapter;
import com.gjson.androidtools.library.imagepicker.adapter.ImageRecyclerAdapter;
import com.gjson.androidtools.library.imagepicker.bean.ImageFolder;
...
import com.gjson.androidtools.library.imagepicker.view.FolderPopUpWindow;
import com.gjson.androidtools.library.imagepicker.view.GridSpacingItemDecoration;
...
public class ImageGridActivity extends ImageBaseActivity
    ...
    ImageRecyclerAdapter.OnImageItemClickListener,
  ...
  @Override public void onImageItemClick(View view, ImageItem imageItem, int position) {
    ...
    if (imagePicker.isMultiMode()) {
      ...
      DataHolder.getInstance()
          .save(DataHolder.DH_CURRENT_IMAGE_FOLDER_ITEMS, imagePicker.getCurrentImageFolderItems());
      intent.putExtra(ImagePreviewActivity.ISORIGIN, isOrigin);
  ...
  public void onImageSelected(int position, ImageItem item, boolean isAdd) {
    if (imagePicker.getSelectImageCount() > 0) {
      mBtnOk.setText(getString(R.string.ip_select_complete, imagePicker.getSelectImageCount(),
          imagePicker.getSelectLimit()));
      mBtnOk.setEnabled(true);
      mBtnPre.setEnabled(true);
      mBtnPre.setText(
          getResources().getString(R.string.ip_preview_count, imagePicker.getSelectImageCount()));
