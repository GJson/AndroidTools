...
public class SQLiteUtils {
   ...
   */
  public static void storeObject(Object obj, SQLiteDatabase db, String tableName,
      HashMap<String, String> extraColumnAndValue)
    ...
    for (Field field : fields) {
      ...
      if (type == int.class || type == Integer.class) {
        ...
        // 获取List中的泛型参数类型
        String className =
            ((ParameterizedType) field.getGenericType()).getActualTypeArguments()[0].toString()
                .split(" ")[1];
   ...
   */
  @SuppressWarnings("rawtypes") public static Object sql2Object(SQLiteDatabase db, String sql,
      Class classs) {
   ...
   */
  @SuppressWarnings("rawtypes") public static List sql2ObjectList(SQLiteDatabase db, String sql,
      Class classs) {
    Cursor cursor = db.rawQuery(sql, null);
   ...
   */
  @SuppressWarnings({ "rawtypes", "unused" }) public static Object cursor2Object(Cursor cursor,
      Class classs) {
    if (cursor == null) {
      return null;
    }
   ...
   * 注意：Cursor里的字段名（可用别名）必须要和Object的属性名一致
   */
  @SuppressWarnings({ "rawtypes", "unchecked" }) public static List cursor2ObjectList(Class classs,
      Cursor cursor) {
    if (cursor == null) {
      return null;
    }
   ...
   * @throws Exception
   */
  @SuppressWarnings("rawtypes") private static Object setValues2Fields(Cursor cursor, Class classs)
      throws Exception {
   ...
   * 判断是否为基本类型
   */
  @SuppressWarnings("rawtypes") private static boolean isBasicType(Class typeClass) {
   ...
   * 获得包装类
   */
  @SuppressWarnings("all") public static Class<? extends Object> getBasicClass(Class typeClass) {
    Class _class = basicMap.get(typeClass);
    if (_class == null) _class = typeClass;
    return _class;
  }

  @SuppressWarnings("rawtypes") private static Map<Class, Class> basicMap =
